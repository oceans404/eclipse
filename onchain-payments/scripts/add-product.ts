...
const productId = 1n;
const price = parseUnits("10", 6); // 10 PYUSD with 6 decimals
const contentId = "nillion://example-content";
...
console.log("\n📋 Product Details:");
const [productPrice, creator, contentIdStored, exists] = await paymentService.read.getProduct([productId]);
...
console.log(`  https://sepolia.etherscan.io/address/${PAYMENT_SERVICE_ADDRESS}`);
