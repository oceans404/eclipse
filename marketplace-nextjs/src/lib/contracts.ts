...
// ProductPaymentService ABI - synced with on-chain contract
export const PRODUCT_PAYMENT_SERVICE_ABI = [
  {
    inputs: [
      { internalType: 'address', name: '_paymentToken', type: 'address' },
      { internalType: 'address', name: '_verifiedList', type: 'address' },
    ],
    stateMutability: 'nonpayable',
    type: 'constructor',
  },
  { inputs: [], name: 'AlreadyPaid', type: 'error' },
  { inputs: [], name: 'InvalidContentId', type: 'error' },
  { inputs: [], name: 'InvalidPrice', type: 'error' },
  { inputs: [], name: 'InvalidTokenAddress', type: 'error' },
  { inputs: [], name: 'InvalidVerifiedListAddress', type: 'error' },
  { inputs: [], name: 'OnlyCreatorCanUpdate', type: 'error' },
  { inputs: [], name: 'ProductAlreadyExists', type: 'error' },
  ...
  },
  {
    inputs: [
      ...
      { internalType: 'bool', name: 'mustBeVerified', type: 'bool' },
    ],
    name: 'addProduct',
    outputs: [],
    stateMutability: 'nonpayable',
  ...
  },
  {
    ...
    name: 'verifiedList',
    outputs: [
      { internalType: 'contract IVerifiedList', name: '', type: 'address' },
    ],
    stateMutability: 'view',
    type: 'function',
  },
...
// USDC Token ABI - subset required for dapp functionality
